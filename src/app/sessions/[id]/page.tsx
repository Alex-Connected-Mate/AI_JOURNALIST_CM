      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-start justify-between">
            <div>
              <Link href="/sessions" className="text-blue-600 hover:text-blue-800 mb-4 inline-flex items-center">
                <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
                Retour au tableau de bord
              </Link>
              <h1 className="text-2xl font-bold mt-2">{session.name}</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="text-lg font-medium mb-3">URL de la session</h3>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-2">Les participants peuvent rejoindre via cette URL :</p>
                ...
                <div className="mt-4">
                  <p className="text-sm text-gray-600 mb-2">Ou utiliser le code de session :</p>
                  <div className="bg-white px-4 py-2 rounded border text-lg font-mono font-bold text-center">
                    {session.code}
                  </div>
                </div>
              </div>
